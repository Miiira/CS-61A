...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        """
        if not isinstance(insect, QueenAnt) or not insect.true_queen:
            if insect.is_ant:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while distance <= self.max_range and current is not hive:
            if current.bees:
...
class LongThrower(ThrowerAnt):
    ...
    def nearest_bee(self, hive):
        ...
        while isinstance(place, Place) and not place.bees:
            place = place.entrance
        if isinstance(place, Place) and place != hive:
...
class ShortThrower(ThrowerAnt):
    ...
    def nearest_bee(self, hive):
        ...
        while isinstance(place, Place) and not place.bees:
            place = place.entrance
            distance += 1
        if isinstance(place, Place) and place != hive and distance <= self.max_range:
            return random_or_none(place.bees)
    # END Problem 6
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.true_queen:
            ...
            while place:
                if place.ant:
                    behind_ants.append(place.ant)
                    if place.ant.container and place.ant.ant:
                        behind_ants.append(place.ant.ant)
                place = place.exit
