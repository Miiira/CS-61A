...
(lambda (x y) (* 3 r x y))
; expect (lambda (x y) (* 3 r x y))

((lambda (x y) (* 3 r x y)) 1 2)
; expect 12

(define long (lambda (k) (- k 1)))
; expect long
...
z
; Error: expect unknown identifier: z
